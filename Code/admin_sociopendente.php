...
<body>
    ...
    <main>
        <div class="sidenav">
            <a id="active" href="#about">Pedidos de Sócio Pendentes</a>
            <a class="hvr-underline-from-left" href="#services">Adicionar Produto</a>
            <a class="hvr-underline-from-left" href="#services">Remover Produto</a>
            <a class="hvr-underline-from-left" href="#clients">Adicionar Jogador</a>
